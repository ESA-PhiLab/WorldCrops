...
with open("../../config/param_config.yaml", "r") as ymlfile:
...
trainer = pl.Trainer(gpus=_gpu, deterministic=True, max_epochs = epochs_pre)
...
trainer = pl.Trainer(gpus=_gpu, deterministic=True, max_epochs = epochs_fine)
