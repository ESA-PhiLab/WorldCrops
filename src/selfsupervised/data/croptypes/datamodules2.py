...
from .timeseries_dataset import DriftNoiseAug, TSAugmented, TSDataSet
...
class BavariaDataModule2(pl.LightningDataModule):
    ...
    def __init__(self,
        ...
        self.feature_list = self.data.columns[self.data.columns.str.contains(
            'B')].tolist()
...
class AugmentationExperiments2(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if self.experiment == 'Experiment1':
            ...
            ts_data = CropInvarianceAug2(train,
                                         self.feature_list,
                                         size=10000,
                                         time_steps=14)
